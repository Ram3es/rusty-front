...
const HistoryDrops = (props) => {
  return (
    <div class='relative lg:h-[176px]'>
      <div class='w-full flex gap-2'>
        <div class='flex flex-col gap-2 lg:gap-3'>
          <TopHistoryLabel>top drops</TopHistoryLabel>
          <div class='flex gap-[5px] lg:gap-2 overflow-x-scroll'>
            <For
              each={props
                .data()
        ...
        <div class='w-full flex flex-col gap-2 lg:gap-3 overflow-hidden'>
          <LiveHistoryLabel>live drops</LiveHistoryLabel>
          <div class='flex gap-[5px] lg:gap-2  xl:max-w-[635px] xll:max-w-[830px] xxl:max-w-[855px] overflow-x-scroll right-semitransparent'>
      ...
      <div
        class='w-full absolute top-3 left-0 h-full z-0'
        style={{
          background:
