...
const PotentialDropItem = (props) => {
  ...
  return (
    <div
      class={`group w-full ${
        props.isHorizontal ? 'min-h-[84px]' : 'min-h-[212px]'
    ...
    >
      ...
      <div class={`w-full rounded-4 relative z-10`}>
        {props.caseName && props.caseName !== 'Free Daily Case' && (
          <div
            class={`absolute left-3 bottom-full z-20 text-11 font-bold ${styles().winPercentColor}`}
          >
            <span
              class='box-content'
              style={{
        ...
        <div
          class={`w-full flex ${
            props.isHorizontal ? 'flex-row pt-2' : 'flex-col pt-[14px] pb-4'
          } justify-items-center`}
        >
          <div class='flex items-center justify-center'>
            <div
              class={`${
                props.isHorizontal ? 'h-[72px] w-[72px]' : 'h-[142px] w-[142px]'
            ...
            >
              ...
              <img alt='item-image' src={props.skin.image} class='w-full h-full relative z-10' />
            </div>
          </div>
          <div
            class={`w-full overflow-hidden space-y-1.5 ${
              props.isHorizontal ? 'flex flex-col justify-center pr-9' : 'px-4'
            }`}
          >
