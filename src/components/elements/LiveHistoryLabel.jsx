const LiveHistoryLabel = (props) => {
  return (
    <div class='relative z-10 w-[100px] flex items-center justify-center gap-1.5 lg:py-[3px] px-1.5 label_background-gradient__red rounded border border-transparent'>
