...
const GrayGradientButton = (props) => {
  return (
    <div
      class={`${props.additionalClass ?? 'h-10 lg:w-max px-1 lg:px-4 gap-3' } relative bg-gray-button-gradient border-[#FFFFFF0A] border center rounded-4 cursor-pointer flex items-center 
