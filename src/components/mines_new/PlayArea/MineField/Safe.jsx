  ...
  return (
    ...
    >
      <div class="w-full h-full  rounded-lg  bg-[#181d36]">
        <div
          class="w-full h-full "
          style="background: linear-gradient(270deg, rgba(62, 139, 255, 0) 0%, rgba(62, 139, 255, 0.12) 50%, rgba(62, 139, 255, 0) 100%), linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.24) 100%);
              box-shadow: inset 0px 2px 3px rgba(0, 0, 0, 0.24), inset 0px 2px 12px rgba(0, 0, 0, 0.12);
              filter: drop-shadow(0px 0px 8px rgba(80, 150, 255, 0.22));"
        >
          <Mine />
        </div>
      </div>
