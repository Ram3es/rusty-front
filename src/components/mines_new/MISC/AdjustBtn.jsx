const AdjustBtn = ({ text, small, onClick }) => {
  return (
    <div
      class={`border  border-[#FFFFFF14] text-gray-9a  p-[2px] h-full ${
        small ? "min-w-[40px] text-xs pt-0" : "min-w-[20px] xll:min-w-[52px] text-[14px]"
