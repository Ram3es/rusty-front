...
const icons = [
  ...
  { name: "soldair", img: iconSoldair },
  { name: "bitcoin", img: iconBitcoin },
  {
    name: "etherium",
    img: iconEtherium,
  },
...
const SubFooter = () => {
  return (
    <div
      class="w-full gap-5 flex lg:gap-7 flex-wrap justify-center items-center p-4 rounded-br-8"
      style={{
        background:
          "radial-gradient(121.17% 118.38% at 46.04% 63.97%, rgba(118, 124, 255, 0.06) 0%, rgba(118, 124, 255, 0) 63.91%), linear-gradient(90.04deg, rgba(26, 27, 48, 0.36) 0%, rgba(25, 28, 53, 0.36) 100%)",
      }}
    >
      <For each={icons}>
        {(icon) => {
