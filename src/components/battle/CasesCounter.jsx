...
const CasesCounter = (props) => {
  ...
  return (
    <div
      ...
      style={{
        background:
          'linear-gradient(270deg, rgba(255, 180, 54, 0) 0%, rgba(255, 180, 54, 0.12) 50%, rgba(255, 180, 54, 0) 100%), linear-gradient(0deg, rgba(0, 0, 0, 0.24), rgba(0, 0, 0, 0.24)), radial-gradient(80.66% 584.01% at 39.62% 51.7%, rgba(31, 35, 68, 0.56) 0%, rgba(35, 37, 61, 0.56) 100%)'
      }}
    >
      <div class='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-16 font-SpaceGrotesk font-bold text-yellow-ffb text-shadow-gold'>
        {props.roundsCount}
      </div>
