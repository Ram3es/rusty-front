            ...
            >
              <div class="center gap-3 flex-col sm:flex-row">
                ...
                <div class="flex flex-col">
                  ...
                  >
                    <div
                      class="text-gray-9a text-12 font-medium capitalize"
                    >
            ...
            <div class="flex flex-col xl:flex-row">
              ...
              >
                <div class="w-full h-20 sm:h-10 flex flex-col-reverse items-end sm:flex-row justify-between gap-2 relative z-10">
                  ...
                  {(props.searchParams?.deposit || props.pathname() == URL.GAMEMODES.JACKPOT_DEPOSIT) && (
                    <div class='balance-bg rounded-4 flex items-center drop-shadow-dark'>
                      <div class='bg-black bg-opacity-10 rounded-4 h-[calc(100%-4px)] flex m-0.5 '>
                        <div
                          class=' w-full h-full px-3 bg-cover py-1 text-16 text-gray-e0 rounded-4 flex gap-2 items-center font-Lato font-bold'
                  ...
                  <div class="center flex-col w-full px-8 gap-3">
                    <div class="center gap-2 p-3 w-full border rounded-4 border-white/10">
                      <div class="flex gap-2 text-14 font-SpaceGrotesk font-bold text-yellow-ffb items-center">
                        <span class="text-white">{settings().amount}
                          {itemsTotal() > 0 && ` / ${itemsTotal()}`} items</span>
                        <span>worth</span>
                        <Coin width="5" />
              ...
              <div class="w-full center flex-col gap-6">
                ...
                >
                  <div class="w-44 h-44 bg-white">
                    <Img style="w-full h-full min-w-full" src={`data:image/png;base64,${crypto()?.QRcode || ""}`} />
                  </div>
                </div>
                <div class="center flex-col gap-2 flex-1 bg-white/[0.02] px-8 py-4">
                  <div class="center flex-col w-full">
                    ...
                    <p class="text-[#646683]">You can send any amount of {cryptomethods[props.searchParams?.method]?.name} to this address and receive equivalent in RustyLoot balance.</p>
                    <div
                 ...
                 "
                   ...
                   linear-gradient(0deg, rgba(255, 255, 255, 0.02), rgba(255, 255, 255, 0.02));
                      ...
                      >
                        ...
                        {crypto()?.address && <div
                          class="bg-gray-button-gradient p-2 rounded-4 border border-white/10"
                        >
                          <svg
                            class="w-4"
                            xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p class="text-14 text-white font-semibold">
                    Send any amount of {cryptomethods[props.searchParams?.method]?.name}{" "}
                    to the address above, and it'll be converted to site balance.
                    3 confirmation(s) required.
                  </p>
                </div>
              </div>
