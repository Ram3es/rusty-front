        ...
        <div class='px-9 py-6 relative'>
          ...
          <div class='w-full flex flex-col gap-3'>
            ...
            <div class='mt-[4px] flex items-center justify-center gap-[7px]'>
              <GrayGradientButton noShadow additionalClass='text-gray-a2 flex items-center justify-center gap-[10px] w-[180px] h-10 rounded-4 shadow-button gradient-gray-background border border-white/5'>
                <svg
                  width='18'
                  height='12'
                  viewBox='0 0 18 12'
              ...
              <GrayGradientButton noShadow additionalClass='text-gray-a2 flex items-center justify-center gap-[10px] w-[180px] h-10 rounded-4 shadow-button gradient-gray-background border border-white/5'>
                ...
                <span class='text-14 text-shadow-base font-bold font-SpaceGrotesk'>Authorize</span>
              </GrayGradientButton>
            </div>
          </div>
        </div>
