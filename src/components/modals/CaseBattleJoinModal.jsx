          ...
          <div class='flex flex-col gap-4 my-8'>
            ...
            >
              <div class='flex gap-2 items-center'>
                ...
                {props.game?.fundBattle ? <div
                  class={"rounded-2 absolute discond-green-border right-0.5 -top-1 -left-5 z-10 px-1 -rotate-[10deg] w-14 center text-green-3e font-Quicksand font-bold text-14"}
                  style={{
                ...
                <span class='text-gradient'>{props.game?.fundBattle ? 
                  (props.game?.totalValue - (props.game?.totalValue * (props.game?.fundPercent / 100))).toFixed() : 
                  setup().borrowMoney ? 
