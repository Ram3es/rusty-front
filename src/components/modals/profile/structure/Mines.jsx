...
const MinesStructure = (props) => {
  ...
  return (
    <>
      ...
      <div
        class={`col-start-2 row-start-2 lg:row-auto lg:col-auto grid grid-cols-[1rem_1fr] lg:flex items-center gap-2`}
      >
        <Coin width="4" />
      ...
      <div class="col-start-1 row-start-3 lg:row-auto lg:col-auto my-auto grid grid-cols-[1rem_1fr] lg:flex items-center gap-x-2 lg:gap-2 relative z-10">
        <span class="col-start-2 lg:col-auto text-14 font-bold font-SpaceGrotesk text-gray-9aa uppercase">
      ...
      <div class="col-start-2 row-start-3 lg:row-auto lg:col-auto grid grid-cols-[1rem_1fr] lg:flex items-center gap-x-2 lg:gap-2 relative z-10">
        <div class="col-span-2 col-start-1 lg:col-auto flex items-center gap-[5px]">
          <svg
            width="22"
            height="20"
            viewBox="0 0 22 20"
        ...
        <span class="col-start-2  text-gray-a2 font-bold capitalize lg:hidden text-13">
          Mines
        </span>
      </div>
