    ...
    return (
        <>
            <div class="flex items-center gap-2">
                ...
                <p class="text-14 text-gray-8c font-medium font-Oswald uppercase my-auto"> {props?.val?.ticker} deposit </p>
            </div>
            <div class={`flex items-center gap-2`}>
                <Coin />
            ...
            <p class="text-14 text-gray-8c font-medium font-Oswald uppercase my-auto max-w-full overflow-hidden truncate">{props?.val?.txid}</p>
            <div class="w-full flex items-center">
                <p class="text-14 text-gray-8c font-medium font-Oswald uppercase my-auto truncate"> {data} </p>
            </div>
        </>
    );
  };
