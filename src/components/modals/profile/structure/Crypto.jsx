...
const CryptoStructure = (props) => {
  ...
  return (
    <>
      <div class="col-start-1 row-start-2 lg:row-auto lg:col-auto lg:flex items-center gap-x-[14px] lg:gap-[9px]">
      ...
      <div class="col-start-1 row-start-3 col-span-2 lg:col-start-3 lg:row-auto lg:col-auto flex items-center gap-2">
      ...
      <div class="col-start-1 row-start-1 col-span-2 lg:col-start-4 lg:row-auto lg:col-auto w-full flex items-center justify-end overflow-hidden relative cursor-pointer">
