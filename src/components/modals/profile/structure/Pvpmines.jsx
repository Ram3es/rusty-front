...
const PvpminesStructure = (props) => {
  ...
  return (
    <>
      ...
      <div class="grid grid-cols-[1rem_1fr] lg:flex items-center gap-x-1 lg:gap-[5px] text-gray-9aa">
        <svg
          width="14"
          height="16"
          viewBox="0 0 14 16"
      ...
      <div class="grid grid-cols-[1rem_1fr] lg:flex items-center gap-x-2 lg:gap-[5px] text-gray-9aa">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
        ...
        <p class="text-14 font-bold font-SpaceGrotesk text-current capitalize my-auto">
          {props?.val?.mode}
        </p>
        <span class="text-gray-a2 font-bold capitalize col-start-2 lg:hidden text-13">
          Mode
