...
const CaseBattlesStructure = (props) => {
  ...
  return (
    <>
      ...
      <div
        class={`col-start-1 row-start-3 lg:row-auto lg:col-auto grid grid-cols-[1rem_1fr] gap-x-2 lg:gap-x-0 items-center text-gray-9a`}
      >
        <div class="flex gap-[5px] col-span-2 items-center">
        ...
        <span class="capitalize col-start-2 lg:hidden text-gray-a2 font-bold text-13">
          Setup
        </span>
      </div>
      <div
      ...
      <p class="col-start-2 row-start-4 lg:row-auto lg:col-auto text-14 font-bold font-SpaceGrotesk text-gray-9aa uppercase my-auto relative z-10">
        <span class="capitalize lg:hidden text-13 font-bold text-gray-a2">
          Borrowed Money
        </span>{" "}
