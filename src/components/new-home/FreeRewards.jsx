...
const FreeRewards  = () => {
    return (
        <div class='max-w-[1152px] w-full mx-auto'>
            ...
            <div class='grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-8 w-full gap-4'>
                <For each={rewards} >
                    {(r) => <div class='home-rewards flex items-center flex-col py-1 px-1 lg:px-4 overflow-hidden justify-between'>
                        {r.image ? <><img
                        src={r.image}
                        alt="rotating dome"
                        class="h-16"
                        ...
                        src={r.image}
                        alt="rotating dome"
                        class="absolute h-22 lg:h-28 right-1/2 top-1/4 -rotate-12 opacity-5"
                        />
                        </> : ""}
